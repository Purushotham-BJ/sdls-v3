...
echo "=== SDLS v3 User-Data: System 1 ==="
apt-get update -q
...
cp "$PROJECT_DIR/systemd/sdls-system1.service" /etc/systemd/system/
systemctl daemon-reload
systemctl enable sdls-system1
systemctl start sdls-system1

echo "=== System 1 bootstrap complete: $(date -u) ==="
